...
const IGNORE = new Set(['key', 'ref', 'children', '__content']);
...
function hyperons(element, props, ...children) {
  ...
  if (typeof element === 'function') {
    ...
    const renderProps = extend(props, { React: { createElement: hyperons } })

    if (element.prototype && typeof element.prototype.render === 'function') {
      const instance = new element(renderProps);
      return instance.render()
    }

    return element(renderProps)
  }
